...
class MultiheadAttention(nn.Module):
    ...
    def forward(self, query, key, value, mask_future_timesteps=False,
        ...
        if key_padding_mask is not None:
            ...
            key_padding_mask = key_padding_mask.unsqueeze(1).unsqueeze(2)  # Shape becomes [32, 1, 1, 69]
            attn_weights = attn_weights.float().masked_fill(key_padding_mask.bool(), float("-inf"))
